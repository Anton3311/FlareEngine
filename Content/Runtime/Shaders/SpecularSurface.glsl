...
layout(set = 3, binding = 2) uniform sampler2D u_SpecularMap;
...
void main()
{
	...
	vec4 specular = texture(u_SpecularMap, uv);
	...
	material.Metallic = u_Material.Metallic * specular.b;
	material.Roughness = u_Material.Roughness * specular.g;
